...
{
	public sealed class PulletTimer
	{
		/// <summary>
		/// 延迟后，触发一次
		/// </summary>
		public static PulletTimer CreateOnceTimer(float delay)
		{
			return new PulletTimer(delay, -1, -1, 1);
		}
		...
		public static PulletTimer CreatePepeatTimer(float delay, float interval)
		{
			return new PulletTimer(delay, interval, -1, -1);
		}
		...
		public static PulletTimer CreatePepeatTimer(float delay, float interval, float duration)
		{
			return new PulletTimer(delay, interval, duration, -1);
		}
		...
		public static PulletTimer CreatePepeatTimer(float delay, float interval, long maxTriggerCount)
		{
			return new PulletTimer(delay, interval, -1, maxTriggerCount);
		}
		...
		/// <param name="delay">延迟时间</param>
		/// <param name="duration">触发周期</param>
		public static PulletTimer CreateDurationTimer(float delay, float duration)
		{
			return new PulletTimer(delay, -1, duration, -1);
		}

		/// <summary>
		/// 延迟后，永久触发
		/// </summary>
		public static PulletTimer CreateForeverTimer(float delay)
		{
			return new PulletTimer(delay, -1, -1, -1);
		}
		...
		public PulletTimer(float delay, float interval, float duration, long maxTriggerCount)
		{
			DelayTime = delay;
