...
namespace PulletFramework.Tween
{
	public abstract class ValueNode<ValueType> : ITweenNode where ValueType : struct
	{
		...
		public ValueNode<ValueType> SetEase(AnimationCurve easeCurve)
		{
			if (easeCurve == null)
			{
				PLogger.Error($"{nameof(AnimationCurve)} param is null.");
				return this;
			}
		...
		public ValueNode<ValueType> SetEase(TweenEaseDelegate easeFun)
		{
			if (easeFun == null)
			{
				PLogger.Error($"{nameof(TweenEaseDelegate)} param is null.");
				return this;
			}
		...
		public ValueNode<ValueType> SetLerp(TweenLerpDelegate lerpFun)
		{
			if (lerpFun == null)
			{
				PLogger.Error($"{nameof(TweenLerpDelegate)} param is null.");
				return this;
			}
