...
namespace PulletFramework.Tween
{
	public static partial class TweenChainExtension
	{
		...
		{
			return chain.Append(PulletTween.AllocateExecute(execute));
		}
		...
		{
			return chain.Append(PulletTween.AllocateUntil(condition));
		}
		...
		{
			var node = PulletTween.AllocateParallel(nodes);
			chain.Append(node);
			return chain;
		}
		...
		{
			var node = PulletTween.AllocateSequence(nodes);
			chain.Append(node);
			return chain;
		}
		...
		{
			var node = PulletTween.AllocateSelector(nodes);
			chain.Append(node);
			return chain;
		}
		...
		{
			return chain.Append(PulletTween.AllocateDelay(delay, trigger));
		}
		...
		{
			return chain.Append(PulletTween.AllocateRepeat(delay, interval, trigger));
		}
		...
		{
			return chain.Append(PulletTween.AllocateRepeat(delay, interval, duration, trigger));
		}
		...
		{
			return chain.Append(PulletTween.AllocateRepeat(delay, interval, maxRepeatCount, trigger));
		}
		...
		{
			return chain.Append(PulletTween.AllocateDuration(delay, duration, trigger));
		}
	}
}